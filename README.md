...
- [x] **Customer-facing subscription page** — `/billing` page in the customer portal shows current plan, per-user usage bars, subscription status badge, available plan cards with upgrade buttons (checkout stub — records intent, toasts "Stripe coming soon"), and billing event history; real Stripe checkout is next phase
