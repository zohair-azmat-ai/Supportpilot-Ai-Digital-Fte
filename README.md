...
- [ ] **WebSocket streaming** — Persistent bidirectional socket for multi-user rooms and sub-token-level streaming (not yet implemented; current SSE approach covers single-user chat fully)
